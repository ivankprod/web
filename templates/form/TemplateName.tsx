...
const formValidityReducer = (state: TemplateNameValidityState, action: TemplateNameValidityAction): TemplateNameValidityState => {
	switch (action.type) {
...
const TemplateName: React.FC = () => {
	...
	return (
		<div className={TemplateNameStyles.wrapper}>
			...
			<form name="template-name" method="POST" onSubmit={onSubmitHandler} data-netlify="true" data-netlify-honeypot="bot-field">
