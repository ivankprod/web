	...
	if (slide) {
		animate({
			...
			draw: function (perc: number) {
				drawOpacity(this.elem, String(perc));
			},
			callback: function () {
		...
		(slide.children[0].children[0] as HTMLElement).style.animation =
			"slideBlockTitle 1600ms cubic-bezier(0.190, 1.000, 0.220, 1.000), fadeIn 600ms linear";
	}
};
